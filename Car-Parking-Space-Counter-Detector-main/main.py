...
cap=cv2.VideoCapture(r'C:\Users\Aditya\Music\Carparking\Car-Parking-Space-Counter-Detector-main\carPark.mp4')

with open(r'C:\Users\Aditya\Music\Carparking\Car-Parking-Space-Counter-Detector-main\CarParkPos','rb') as f:
...
def check(imgPro):
    ...
    cv2.rectangle(img,(45,30),(250,75),(0,0,0),-1)
